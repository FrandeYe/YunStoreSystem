...
public class MusicController extends BaseController{
	...
	public void index() {
		render("material/music/index.vm");
	}
	
	
	public void uploadView() {
		render("material/music/upload.vm");
	}
		...
		if (null != uploadFiles) {
			for(UploadFile uploadFile: uploadFiles) {
				...
				if (null != result && result.isSuccess()) {
					...
					video.set("v_url", "/"+SysConfig.uploadPath + result.get("savePath")).set("v_name", uploadFile.getFileName())
					.set("create_by", getAdminId()).set("created_at", new Date()).set("m_type", EnumConstant.MaterialType.MUSIC.getValue());
	...
	public void list() {
		Kv kv = Kv.by("pageNumber", get("pageNumber")).set("pageSize", get("pageSize")).set("type", EnumConstant.MaterialType.MUSIC.getValue());
