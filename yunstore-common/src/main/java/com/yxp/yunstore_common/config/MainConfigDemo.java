package com.yxp.yunstore_common.config;
...
import com.yxp.yunstore_common.plugin.TableBindPlugin;

public class MainConfigDemo extends JFinalConfig {
	/**
	 * 将全局配置提出来 方便其他地方重用
	 */
	...
	public static String resourcePath;//静态文件访问网址
	...
	public void configPlugin(Plugins me) {
		...
		TableBindPlugin bind = new TableBindPlugin(dbPlugin);
		bind.scanPackages("com.yxp.yunstore_common.model"); 
		bind.autoScan(false);
		bind.setShowSql(true);
